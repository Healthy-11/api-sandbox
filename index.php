...
$app->post(
  ...
  function () use ($app) {
    ...
    if ($userData == null)
      ...
      $app->db->execute("INSERT INTO flight (type, specie, date, note, userId) VALUES ('" . $data->type . "', '" . $data->specie . "', " . $data->date . ", '" . $data->note . "', '" . $data->userId . "')");
...
$app->put(
  ...
  function ($id) use ($app) {
    ...
    if ($userData == null)
      ...
      $app->db->execute("UPDATE flight SET type = '" . $data->type . "', specie = '" . $data->specie . "', date =  '" . $data->date . "', note = '" . $data->note . "', userId = '" . $data->userId . "' WHERE id =" . $id);
